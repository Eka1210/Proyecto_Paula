        ...
        <div class="display-info">
            ...
            <?php if ($producto->encargo == 1): ?>
                <form action="/personalizar/producto" method="get">
                    ...
                    <button class="" type="submit">Personalizar</button>
                </form>
            <?php else: ?>
                <form action="/cart/AddToCart" method="post" style="margin-bottom: 10px;">
                    <input type="hidden" value="<?php echo htmlspecialchars($producto->id); ?>" name="producto">
                    <input type="hidden" value="<?php echo htmlspecialchars($producto->price); ?>" name="price">
                    ...
                    <button class="button cart" type="submit">Agregar al Carrito</button>
                </form>

                <button class="display-heart" data-product-id="<?php echo htmlspecialchars($producto->id); ?>">
