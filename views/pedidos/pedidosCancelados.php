...
<div class="detalle"style="margin-bottom: 2rem;">   
    <h1 class="section__heading"><span> Historial de Pedidos Cancelados</span></h1>
                ...
                <tbody class="table__tbody">
                    <?php foreach($pedidos as $pedido){ ?>
                        <tr class="table__tr">
                            ...
                            <td class="table__td">
                                <form action="/admin/pedidos/guardarEstado" method="POST" onsubmit="return confirm('¿Está seguro de guardar los cambios?')">
