...
<div style="display: flex; justify-content: space-between; align-items: center; margin: 0 20px;">
    <a href="/admin/metodosPago" class="form__submit--orange">
...
<div class="detalle">   
    <h1 class="section__heading"><span> Métodos de Pago Deshabilitados </span></h1>
                ...
                <tbody class="table__tbody">
                    <?php foreach($metodosPago as $metodo){?>
                        ...
                        <td class="table__td">
                            ...
                            <td class="table__td">
                            <form action="/admin/metodosPago/activoP2" method="POST">
